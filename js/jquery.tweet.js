  ...
  $.fn.tweet = function(o){
    ...
    $.fn.extend({
      ...
      linkHash: function() {
        ...
        var regexp = /(?:^| )[\#]+([A-Za-z0-9-_]+)/gi;
        this.each(function() {
          returning.push(this.replace(regexp, ' <a href="https://'+s.twitter_search_url+'/search?q=%23$1 from%3A'+s.username.join("%2BOR%2B")+'">#$1</a>'));
        });
        return $(returning);
      },
      capAwesome: function() {
    ...
    return this.each(function(i, widget){
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.statuses || data, function(item){
